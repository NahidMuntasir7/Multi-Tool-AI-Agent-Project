...
An intelligent AI agent that uses multiple tools to answer medical questions by querying multiple databases converted from CSV files (Heart Disease, Cancer, Diabetes) and performing web searches for general medical knowledge.

## 📋 Features

- **Multi-Database Querying**: Query 3 medical databases converted from CSV files using natural language
